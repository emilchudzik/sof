...
C_CONTROLMUX(Capture Mux, PIPELINE_ID,
	CONTROLMUX_OPS(volsw, 256 binds the mixer control to volume get/put handlers, 256, 256),
...
W_MUX(0, PIPELINE_FORMAT, 2, 2, 2, LIST(`		', "Capture Mux PIPELINE_ID"))
...
PCM_CAPABILITIES(Mux Capture PCM_ID, `S32_LE,S24_LE,S16_LE', 48000, 48000, 2, PIPELINE_CHANNELS, 2, 16, 192, 16384, 65536, 65536)
